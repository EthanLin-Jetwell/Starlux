({
            ...
            if (FormType == 'trustee') {
                for (var i = 0; i<RequiredTrusteeFields.length; i++ ) {
                    ...
                    if (!fieldValueTrustee || fieldValueTrustee == '') {
                        	console.log(RequiredTrusteeFields[i]);
    ...
    ProcessFormFields : function (component, event, helper) {
        ...
        try {
            ...
            var specialItem = component.find("SpecialItem").get("v.value");
            var additionalDescription = component.find("AdditionalDescription").get("v.value");
            
            eventFields["Description"] = 'Item in Baggage: ' + specialItem + '\n' + 'Weight of Baggage: ' + weight + weightUnit + '\n' + 'Size of Baggage: ' + size + sizeUnit;
