({
    ...
    handleOnload : function(component, event, helper) {
        ...
        var values = [
            {'label': $A.get("$Label.c.webForm_formSpecial_isNotPassengerCheck"), 'value': "trustee" },
          {'label': $A.get("$Label.c.webForm_formSpecial_isPassengerCheck"), 'value': "passenger" }                                           
          ,
        ];
        ...
        component.find("CaseSubTypeDetails").set("v.value", "Passenger Assistance");    
