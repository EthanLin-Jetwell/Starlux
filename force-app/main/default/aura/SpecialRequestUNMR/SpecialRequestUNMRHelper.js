({
    ...
    ProcessFormFields : function (component, event, helper) {
        ...
        try {
            ...
            //Description
            var arrivalName = component.find("ArrivalContactName").get("v.value");
            var arrivalPhone = component.find("ArrivalPhone").get("v.value");
            var arrivalRelationship = component.find("ArrivalRelationship").get("v.value");
            var arrivalCountryCode = component.find("ArrivalCountryCode").get("v.value");
            var departureName = component.find("DepartureContactName").get("v.value");
            var departurePhone = component.find("DeparturePhone").get("v.value");
            var departureRelationship = component.find("DepartureRelationship").get("v.value");
            var departureCountryCode = component.find("DepartureCountryCode").get("v.value");
            ...
            eventFields["Description"] += '\n' + 'Departure Contact Name: ' + departureName + '\n' + 'Departure Contact Phone: ' + departureCountryCode + departurePhone + '\n' + 'Departure Contact Relationship: ' + departureRelationship;
            eventFields["Description"] += '\n' + 'Arrival Contact Name: ' + arrivalName + '\n' + 'Arrival Contact Phone: ' + arrivalCountryCode + arrivalPhone + '\n' + 'Arrival Contact Relationship: ' + arrivalRelationship;
